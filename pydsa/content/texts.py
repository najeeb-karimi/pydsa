...
CHANGELOG = """📝 Changelog for this major release:
   ★ Installable Package with the pydsa Command
   ★ Data Structure Logic Separated from the Console
   ★ Shared Menus Without Recursive Navigation
...
CHAINING_INFO = "ℹ️ Since Chaining uses another data structure for collision resolution, the hash table remains dynamic, so you need not worry about storage space!\n"
